...
const AppleIcon = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M350.5 129.5c-26.2 0-52.2 15.2-66.2 15.2-14.6 0-37.1-14.8-61.1-14.8-45.2 0-90.8 33.9-90.8 102.2 0 18.3 3.4 37.4 10.2 56.5 9 25 42.3 86.3 73.3 86.3 14.2 0 35.7-10.3 53.7-10.3 17.2 0 33.3 10.3 52.8 10.3 31.6 0 64.3-55.6 73.1-80.6-68.1-30.3-63.7-107.8-63.7-109.5 0-2.4.2-4.6.5-6.8-5.9-.8-11.7-1.2-17.8-1.2zM284.6 0c-30.1 0-56.6 23.9-56.6 55.7 0 27.8 21.3 54.2 55.1 54.2 32.6 0 56.5-26.7 56.5-55.6 0-30.8-24.1-54.3-55-54.3z" />
  </svg>
);
