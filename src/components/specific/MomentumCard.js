    ...
    return (
      <div className="bg-gray-800/50 border border-gray-700/50 rounded-lg p-6 backdrop-blur-sm">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Momentum Indicators Dashboard</h3>
        </div>
  ...
  const getMomentumGaugeSegments = () => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      segments.push(
        <div
          key={i}
          className={`h-2 flex-1 rounded-full ${isActive ? colors[i] : 'bg-gray-700'} transition-all duration-300`}
        />
      );
    }
    return segments;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700/50">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-400">Current ADX:</span>
                <span className="text-sm font-semibold text-white">{adx_analysis.current_adx}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-semibold ${
                  ...
                  adx_analysis.trend_direction === 'Bearish' ? 'text-red-400' : 'text-gray-400'
                }`}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-semibold ${
                  ...
                  macd_analysis.histogram_trend?.includes('Fading') ? 'text-red-400' : 'text-gray-400'
                }`}>
                  {macd_analysis.histogram_trend}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-400">Crossover:</span>
                <span className={`text-xs ${
                  macd_analysis.recent_crossover?.includes('Bullish') ? 'text-green-400' :
                  macd_analysis.recent_crossover?.includes('Bearish') ? 'text-red-400' : 'text-gray-400'
                }`}>
        ...
        {rsi_analysis && !rsi_analysis.error && (
          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700/50">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-400">Current RSI:</span>
                <span className="text-sm font-semibold text-white">{rsi_analysis.current_rsi}</span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className={`text-xs font-semibold ${
                  ...
                  rsi_analysis.zone?.includes('Strong') ? 'text-lime-400' : 'text-gray-400'
                }`}>
                  {rsi_analysis.zone}
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm ${
                  ...
                  rsi_analysis.trend === 'Falling' ? 'text-red-400' : 'text-gray-400'
                }`}>
                  {rsi_analysis.trend}
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className={`text-xs ${
                  ...
                  rsi_analysis.divergence?.includes('Bearish') ? 'text-red-400' : 'text-gray-400'
                }`}>
          ...
          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700/50">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-white">{volume_momentum.current_volume}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-gray-400">20D Avg:</span>
        ...
        <div className="mb-4 p-3 bg-gray-900/30 rounded-lg border border-gray-700/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-semibold text-white">{score_breakdown.total || 0}</p>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="space-y-1.5">
            {momentum_factors.map((factor, idx) => (
              <div key={idx} className="flex items-start gap-2">
                ...
                <span className={`text-xs ${
                  factor.startsWith('✅') ? 'text-gray-200' : 'text-gray-400'
                }`}>
