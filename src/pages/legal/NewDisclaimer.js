...
const NewDisclaimer = ({ currentUser, onSignIn, onSignOut, onGetStarted, onFaqOpen, onContactOpen, onClose }) => {
  return (
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="flex justify-center mb-4">
              <AlertTriangle className="h-16 w-16 text-warning-500 dark:text-warning-400" />
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-soft-lg p-8 md:p-12 space-y-8 border border-gray-200 dark:border-gray-700">
            <div className="bg-warning-50 dark:bg-warning-900/20 border-2 border-warning-500 dark:border-warning-600 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3 flex items-center">
                <AlertTriangle className="h-6 w-6 text-warning-500 dark:text-warning-400 mr-2" />
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">1. Not Financial Advice</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">2. Past Performance</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">3. Risk of Loss</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">4. AI and Algorithm Limitations</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">5. No Guarantees</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                We do not guarantee:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">6. Independent Decision Making</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">7. Regulatory Compliance</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">9. Acknowledgment</h2>
              <div className="bg-primary-50 dark:bg-primary-900/30 border-l-4 border-primary-500 dark:border-primary-600 p-6 rounded-lg">
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
